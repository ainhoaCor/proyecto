...
<head>
  ...
  <!-- ICONOS QUE SE USAN EN EL FOOTER-->
...
<body>
  <header>
    ...
    <div class="wrapper">
      <div class="logo">
        <img id="logop" src="../../am_blanco.png">
      </div>
      <nav id="navbar" class="navbar navbar-expand-lg bg-dark-tertiary">
...
try { ?>
  <div class="container text-center">
      <form action="CreateCharge.php" method="post" id="payment-form">
        <div class="form-row">
          <label for="card-element" style="font-size:25px;">
        ...
        <button class="btn btn-success" id="pagar" type="submit" >Pagar</button><br>
        <a href="../merchandising.php" id="volverP">Volver</a><br><br>
        <img src='../img/tarjeta.png' style="width:250px; height: 100px;">
  ...
  <script>
    // Crear un Stripe client.
    var stripe = Stripe('pk_test_51NDZKqIspXLT1H92p1ofLdBnV2zblNWqKd0VhWMpdvqzBY5X40EQshYXS6AN5c3DM8yb7faqBXknVWy097Zcnp66009OfAS9v4');
    ...
    function stripeTokenHandler(token) {
      ...
      form.submit();
        ...
        <div class="container text-center" id="errorPago">
            <p> Ha habido un fallo, vuelve a intentarlo :( </p>
