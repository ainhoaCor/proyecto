...
try {
    ...
    if (isset($_POST["stripeToken"])) {
      ...
      if (isset($_SESSION['carrito'])) {
        ...
        $total = 0;
        foreach ($miCarro as $producto) {
          $total += $producto['Price'] * $producto['Ud'];
          $totalCent = round($total * 100);
        }
      } else {
      ...
      <div class="container-fluid p-2">
        ...
        <tr>
            ...
            <td style='vertical-align: middle;'>{$cargo->payment_method_details->card->last4}</td>
            <td style='vertical-align: middle;'>{$datosEnvio}</td>
