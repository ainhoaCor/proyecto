...
<body>
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarNav">
						<ul class="navbar-nav">
							...
							<li class="nav-item">
								<a class="nav-link active text-light" href="../carrito_compra/merchandising.php">Merchandising</a>
							</li>
	...
	<section class="container wrapper">
		<div class="d-flex justify-content-center">
			...
			<form id="formAdmin">
				<div class="mb-3 w-70">
					<label for="exampleInputEmail1" class="form-label">INICIAR SESION</label><br>
				...
				<a href="SignUp.php">¿No estas registrado? Sign up</a>
				<br><br>
			...
			function confirmar() {
				...
				xhttp.onreadystatechange = function() {
					if (this.readyState == 4 && this.status == 200) {
						...
						if (response == 'OK') {
							window.location.href = "merchandising.php";
						} else {
				...
				xhttp.open("GET", "inicio_cliente.php?email=" + email + "&password=" + password, true);
				xhttp.send();
